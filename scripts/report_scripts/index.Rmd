...
variants of concern (VOC) and signature mutations by which they are characterised. This report provides an overview of the evolution of VOCs found
in the analysed samples across given time points and locations. The visualizations below show the proportion 
of the VOCs found in the samples and the allele frequency values of the individual 
signature mutations. The abundance values for the variants are derived 
