...
```
This report provides an overview of the evolution of variants-of-concern (VOC) of SARS-CoV-2 
over given time points and locations.The visualizations below show the proportion 
of the VOCs found in the samples and the allele frequency values of the individual 
signature mutations that characterize the VOCs. The abundance values for the variants are derived 
by deconvolution (for details please see the variantreport_p_sample) and the frequencies of the mutations 
