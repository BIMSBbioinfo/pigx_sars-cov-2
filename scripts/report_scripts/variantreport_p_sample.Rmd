...
match.df <- read.table("match.csv", sep = ",", header = TRUE, colClasses = "character")
sigmuts_deduped <- read.table("sigmuts.csv", sep = ",", header = TRUE, colClasses = "character")
  
# get all possible mutations
all_mutations <- sigmuts_deduped$value
output_mutations <- paste0 (csv_output_dir,"/data_mutation_plot.csv")
