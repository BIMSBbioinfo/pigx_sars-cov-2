...
# if not:
    output_variant_plot <- data.frame(samplename = sample_name, # brauche ich als input von sample sheet 
                                      date = date,
                                      time = time,
                                      location_name = location_name,
                                      coordinates_lat = coordinates_lat,
                                      coordinates_long = coordinates_long
                                        # the script will add columns for the variants )
    )
# strategy: dataframe already exists
# 1. add a new row with samplename and meta data - fill missing cols with NA
# 2. 
