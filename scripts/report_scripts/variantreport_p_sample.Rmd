...
```
```{r calculate_sigmat_weigths, message=F, warning=F, include = FALSE, eval = FALSE}
...
# TODO maybe the WT should also be weighted

if ( exists(msig_simple_unique_weighted)){
