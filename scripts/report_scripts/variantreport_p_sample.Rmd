...
each present variant. Deconvolution relies on signature mutations of each virus strain/variants. It aims to predict the 
individual contributions of the variants/strains to the observed mutation frequencies in the bulk wastewater sample.
TODO: Limitation, be careful with the results when....
