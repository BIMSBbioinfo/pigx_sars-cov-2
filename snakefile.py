...
#output into krakendir please or else but rule generateFilesSite has to find it 
rule krona_report:
    input: 
...
rule renderSite:
    input:
        ...
        expand(os.path.join(REPORT_DIR, "{sample}.qc_report_per_sample.html"), sample = SAMPLE_NAMES),
    output:
