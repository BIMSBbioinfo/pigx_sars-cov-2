...
### CHANGE HERE when using a different mutation sheet

# mutation sheet containing alpha, beta, gamma, delta, BA1, BA2
mutation_sheet <- "mutation_sheet_220209_t07.csv"

# simulation experiment: alpha, gamma, delta, BA1, BA2, mu, lambda 
# mutation_sheet <- "mutation_sheet_simulation_NT_t07_mu_lambda.csv" 

# only mutations on spike RBD
# mutation_sheet <- "Muts_RBDOnly_220207_wholegenomeReferene_t02.csv"

### CHANGE PATHES HERE e.g. when using a mount

#### amedes-data real
## alignemnts at: /local/Projects/AAkalin_pathogenomics/results/amedes_data/output/mapped_reads
## example samples: 12200099 (should show 100% omicron)

# vep_file <- "/local/Projects/AAkalin_pathogenomics/results/220210_simulated_amedes_se/output/variants/12200099_vep_sarscov2_parsed.txt"

# snv_file <- "/local/Projects/AAkalin_pathogenomics/results/220210_simulated_amedes_se/output/variants/12200099_snv.csv"


#### amedes-data single-end 
## alignemnts at: /local/Projects/AAkalin_pathogenomics/results/220210_simulated_amedes_se/output/mapped_reads

# vep_file <- "/local/Projects/AAkalin_pathogenomics/results/220210_simulated_amedes_se/output/variants/amedes_simulated_se_vep_sarscov2_parsed.txt"

# snv_file <- "/local/Projects/AAkalin_pathogenomics/results/220210_simulated_amedes_se/output/variants/amedes_simulated_se_snv.csv"

#### NY iSeq data
## alignmnts at: /local/Projects/AAkalin_pathogenomics/results/NY_SpikeRBD_wastewater/output_WholeGenomeRef_iSeq/mapped_reads
## example sample to investigate: iSeq_RBD_NY23 (good coverage, good results), iSeq_RBD_NY13(near 0 alignment rate)

# vep_file <- "/local/Projects/AAkalin_pathogenomics/results/NY_SpikeRBD_wastewater/output_WholeGenomeRef_iSeq/variants/iSeq_RBD_NY23_vep_sarscov2_parsed.txt"

# snv_file <- "/local/Projects/AAkalin_pathogenomics/results/NY_SpikeRBD_wastewater/output_WholeGenomeRef_iSeq/variants/iSeq_RBD_NY23_snv.csv"

#### NY MiSeq data
## alignmnts at: /local/Projects/AAkalin_pathogenomics/results/NY_SpikeRBD_wastewater/output_WholeGenomeRef_iSeq/mapped_reads
## example sample to investigate: NY10_5-26RBDB_H11_S95 (missing delta)

# vep_file <- "/local/Projects/AAkalin_pathogenomics/results/NY_SpikeRBD_wastewater/output_WholeGenomeRef_MiSeq/variants/NY10_5-26RBDB_H11_S95"

# snv_file <- "/local/Projects/AAkalin_pathogenomics/results/NY_SpikeRBD_wastewater/output_WholeGenomeRef_MiSeq/variants/NY10_5-26RBDB_H11_S95_snv.csv"


### example working deconvolution-MDC data, Sep 2021 ###
