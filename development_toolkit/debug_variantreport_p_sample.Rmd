...
<span style="color:darkred">Locations of wastewater processing plants have been generated arbitrarily and do 
not correspond to actual locations.</span>
...
sample_name <- "Test10"
# sample_name <- "WW_210209_WA"
# sample_sheet <- data.table::fread(params$sample_sheet)
location_sigmuts <- "signature_mutations"
date <- "2021-05-06"
location_name <- "berlin"
coordinates_lat <- "52.5621572404487"
coordinates_long <- "13.4155862239246"
deconvolution_functions <- "deconvolution.R"
mutation_sheet <- "mutation_sheet_220209_t07.csv"
# works

# doesnt work
# vep_file <- "/mnt/bimsb_local/pigx_sarscov2_ww/210531_wastewaterARTICEW109_pigxsarscov2ww_default/output/variants/WW_210427_22-24h_vep_sarscov2_parsed.txt"
#vep_file <- "/mnt/beast/pathogenomics/pigx_ww/example_report_complete/output/variants/WW_210219_KW1_vep_sarscov2_parsed.txt"

# vep_file <- "/mnt/beast/pathogenomics/vpipe/akalinlab_pathogenomics/misc_src/pigx_sarscov2_ww/tests/output/variants/Test2_vep_sarscov2_parsed.txt"

# vep_file <- "/mnt/beast/pathogenomics/vpipe/akalinlab_pathogenomics/misc_src/pigx_sarscov2_ww/tests/output/variants/Test_empty_vep_vep_sarscov2_parsed.txt"
# vep_file <- "/mnt/beast/pathogenomics/pigx_ww/210902_ww_berlin_febjune_pub_fastp/output/variants/WW_210225_Berlin_KW1_22-24_vep_sarscov2_parsed.txt"
# vep_file <- "/mnt/beast/pathogenomics/pigx_ww/210902_ww_berlin_febjune_pub_fastp/output/variants/merged_939_2berlin21051922-24hmix_vep_sarscov2_parsed.txt"

# vep_file <- "/mnt/bimsb_local/covidCG_data/covidCG_NTmatchingAA_t07_parsed.txt"



# works
# doesnt work
# snv_file <- "/mnt/bimsb_local/pigx_sarscov2_ww/210531_wastewaterARTICEW109_pigxsarscov2ww_default/output/variants/WW_210427_22-24h_snv.csv"
#snv_file <- "/mnt/beast/pathogenomics/pigx_ww/example_report_complete/output/variants/WW_210219_KW1_snv.csv"

# snv_file <- "/mnt/beast/pathogenomics/vpipe/akalinlab_pathogenomics/misc_src/pigx_sarscov2_ww/tests/output/variants/Test2_snv.csv"

# snv_file <- "/mnt/beast/pathogenomics/vpipe/akalinlab_pathogenomics/misc_src/pigx_sarscov2_ww/tests/output/variants/Test_empty_vep_snv.csv"

# snv_file <- "/mnt/beast/pathogenomics/pigx_ww/210902_ww_berlin_febjune_pub_fastp/output/variants/WW_210225_Berlin_KW1_22-24_snv.csv"

### DEBUGGING DECONVOLUTION ###
vep_file <- "trimmed_210916-20-22h-mix_S1_vep_sarscov2_parsed.txt"
snv_file <- "trimmed_210916-20-22h-mix_S1_snv.csv"

# vep_file <- "/mnt/beast/pathogenomics/pigx_ww/210902_ww_berlin_febjune_pub_fastp/output/variants/WW_210325_Berlin_KW2_morning_vep_sarscov2_parsed.txt"
# snv_file <- "/mnt/beast/pathogenomics/pigx_ww/210902_ww_berlin_febjune_pub_fastp/output/variants/WW_210325_Berlin_KW2_morning_snv.csv"

# vep_file <- "/mnt/beast/pathogenomics/pigx_ww/210902_ww_berlin_febjune_pub_fastp/output/variants/merged_939_3berlin21052720-22hmix_vep_sarscov2_parsed.txt"
# snv_file <- "/mnt/beast/pathogenomics/pigx_ww/210902_ww_berlin_febjune_pub_fastp/output/variants/merged_939_3berlin21052720-22hmix_snv.csv"


# snv_file <- "/mnt/beast/pathogenomics/pigx_ww/210902_ww_berlin_febjune_pub_fastp/output/variants/merged_939_4berlin21052722-24hmix_snv.csv"
``` 
...
vepfile.df <- read.table(vep_file, sep = ",", header = T) 

vepfile.df <- na_if(vepfile.df, "-")

# !!! this crashed when the signature mutation dataframe does not contain any shared mutatations !!! 
...
} else { sigmuts_deduped <- sig_mutations.df}
...
variant_protein_mut <- get_protein_mut(vep_file)
...
lofreq.info <- as_data_frame(parse_snv_csv(snv_file)) 
...
```{r, include = F}
snvs <- readLines(snv_file) %>% paste0(collapse="\n") %>% base64_urlencode()
```
Called SNVs:  
...
vep <- readLines(vep_file) %>% paste0(collapse="\n") %>% base64_urlencode()
```
...
output_variants <- file.path("data_variant_plot.csv")
...
for (i in all_variants){
  if (i %in% df$name){
    ...
    if (i %in% colnames(output_variant_plot)) {
        ...
        output_variant_plot <- output_variant_plot %>% mutate(others = 1-rowSums(across(all_of(variants))))
}
  }
}
...
# #complete.df <- complete.df %>% mutate(pasteries = paste(complete.df$AA_mut[!is.na(complete.df$AA_mut)],complete.df$gene_mut,sep = "::"))
...
#   i_AA <- str_split(i,"::")[[1]][1]
#   if (i_AA %in% complete.df$AA_mut ){ # split gene name to match with AA mut
#     # check if variant already has a column
#     if ( i %in% colnames(output_mutation_frame)) {
#         output_mutation_frame[,i] <- complete.df$freq[ which(complete.df$AA_mut == i_AA)]
# }}}
