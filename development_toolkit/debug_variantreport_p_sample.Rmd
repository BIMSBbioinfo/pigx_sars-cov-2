---
title: "debug variant_report weighted"
date: 21.04.21
output:
...
# mutation_sheet <- "mutation_sheet_ucsd_220309_t07.csv"
...
# vep_file <- "12200099_vep_sarscov2_parsed.txt"
# 
# snv_file <- "12200099_snv.csv"
...
# vep_file <- "amedes_simulated_se_vep_sarscov2_parsed.txt"
# 
# snv_file <- "amedes_simulated_se_snv.csv"

#### NY iSeq data
## alignmnts at: /local/Projects/AAkalin_pathogenomics/results/NY_SpikeRBD_wastewater/output_WholeGenomeRef_iSeq/mapped_reads
## example sample to investigate: iSeq_RBD_NY13

# vep_file <- "iSeq_RBD_NY13_vep_sarscov2_parsed.txt"
# 
# snv_file <- "iSeq_RBD_NY13_snv.csv"

#### NY MiSeq data
## alignmnts at: /local/Projects/AAkalin_pathogenomics/results/NY_SpikeRBD_wastewater/output_WholeGenomeRef_iSeq/mapped_reads
## example sample to investigate: NY10_5-26RBDB_H11_S95 (missing delta)

# vep_file <- "NY10_5-26RBDB_H11_S95_vep_sarscov2_parsed.txt"
# 
# snv_file <- "NY10_5-26RBDB_H11_S95_snv.csv"
...
# vep_file <- "WW_210219_Berlin_KW1_vep_sarscov2_parsed.txt"
# snv_file <- "WW_210219_Berlin_KW1_snv.csv"

### amedes_real_data - debug handling value distribution of grouped cases
# vep_file <- "WW-T12-001_2021-08-28_Berlin_A_vep_sarscov2_parsed.txt"
# snv_file <- "WW-T12-001_2021-08-28_Berlin_A_snv.csv"

# vep_file <- "WW-T14-003_2021-09-06_Berlin_C_vep_sarscov2_parsed.txt"
# snv_file <- "WW-T14-003_2021-09-06_Berlin_C_snv.csv"


### sandiego
vep_file <- "Test0_se_vep_sarscov2_parsed.txt"
snv_file <- "Test0_se_snv.csv"
``` 
...
nomatch.df <- complete.df %>%
                        filter(is.na(name))
```
```{r try_filter_low_cov_mutations}

match_filtered.df <- match.df %>%
                        filter( as.numeric(cov) > 100)
match.df <- match_filtered.df
```
...
wt_weight <- as.numeric(sigmut_proportion_weights["WT"])
